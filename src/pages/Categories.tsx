...
const subcategoryOptions: Record<string, string[]> = {
  "Courses": ["All", "AI", "Machine Learning", "Python", "English Language", "Business School"],
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 pt-20 pb-32 flex flex-col items-center">
      <h1 className="text-4xl md:text-5xl lg:text-6xl font-michroma text-white tracking-tight mb-6 text-center">
        Explore Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400">Categories</span>
      </h1>
